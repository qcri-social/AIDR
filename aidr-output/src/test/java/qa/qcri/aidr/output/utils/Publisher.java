...
public class Publisher {
    ...
    public Publisher(Jedis publisherJedis, String channel,Long nItems) {
        ...
        this.nItems=nItems;
        Long persisterLoadLimit = Long.valueOf(OutputConfigurator.getInstance().getProperty(OutputConfigurationProperty.PERSISTER_LOAD_LIMIT));
        sleepDuration = (60*1000)/persisterLoadLimit;
    }
