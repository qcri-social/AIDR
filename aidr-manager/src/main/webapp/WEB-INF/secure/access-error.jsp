...
<div class="headerWrapper">
    <div class="header"><img src="${pageContext.request.contextPath}/resources/img/AIDR/aidr_logo_50h.png"></div>
</div>

<div class="mainWraper">
    <div class="main">
        <div>
            <p align="center">Sorry, you are trying to access a protected resource for which you do not have access rights.</p>
            <div>
                <a href="home">Go to Collections Manager home page</a>
            </div>
            <br/><br/>
        </div>
    </div>
