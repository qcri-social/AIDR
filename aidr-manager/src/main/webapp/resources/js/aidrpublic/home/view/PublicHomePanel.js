        ...
        this.collectionTpl = new Ext.XTemplate(
            ...
            '</div>',
            {
                getImageLink: function (rawCode, rawName, hasTaggerOutput) {
                    ...
                    if(hasTaggerOutput){
//                        return '<a href="http://aidr-web.qcri.org/AIDROutput/aidrTaggerLatest.html?crisisCode='+ encodeURI(rawCode) +'"><img alt="Collection image" height="70" src="/AIDRFetchManager/resources/img/collection-icon.png" width="70"></a>';
...
//                       return '<a href="http://aidr-web.qcri.org/AIDROutput/aidrTaggerLatest.html?crisisCode='+ encodeURI(rawCode) +'">'+ rawName +'</a>';
