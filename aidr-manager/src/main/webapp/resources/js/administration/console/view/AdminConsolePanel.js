...
Ext.define('ADMIN.console.view.AdminConsolePanel', {
    ...
    initComponent: function () {
        ...
        this.runningCollectionsGrid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [  
                {
                    xtype: 'gridcolumn', dataIndex: 'name', text: 'Collection', width: 200,
...
//                      round to the next hour
                ...
                {
                    xtype: 'gridcolumn', dataIndex: 'totalCount', text: 'Collected tweets', width: 120, align: "right", sortable: false,
                    renderer: function (value, meta, record) {
