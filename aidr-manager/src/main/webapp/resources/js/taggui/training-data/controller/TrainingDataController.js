	        		...
	        		success: function (response) {
	        			...
	        			if (resp.success && resp.data) {
	        	        	...
	        	        	if( countTrainingExample > 0){
	        	        		...
	        	        		me.mainComponent.taggerDescription2line.setText('<b>' + totalHumanLabeledCount + '</b> human-tagged items. '+ statusMessage, false);
	        	        	}
	        	        	else{
	        				...
	        				AIDRFMFunctions.setAlert("No human tagged items present for this classifier.");
	        			}
	        		}
	        	});
