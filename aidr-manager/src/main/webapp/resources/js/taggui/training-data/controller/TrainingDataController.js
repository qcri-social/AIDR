...
//	        							do not count any data from labels with code == null
	        						...
	        						me.mainComponent.taggerDescription.setText('Status: <b>' + status + '</b>. ' +
	        								'Machine-tagged '+ ITEM_PLURAL + ': <b>' + totalMessages + '</b>.&nbsp;' + detailsForModel, false);
	        		...
	        		me.mainComponent.breadcrumbs.setText('<div class="bread-crumbs">' +
	        				...
	        				MODEL_NAME + '&nbsp;>&nbsp;Human-tagged '+ ITEM_PLURAL + '</span></div>', false);
	        		...
	        		success: function (response) {
	        			...
	        			if (resp.success && resp.data) {
	        	        	...
	        	        	if( countTrainingExample > 0){
	        	        		...
	        	        		//me.mainComponent.taggerDescription2line.setText('<b>' + TRAINING_EXAMPLE + '</b> human-tagged '+ ITEM_PLURAL + '. '+ statusMessage, false);
	        	        		me.mainComponent.taggerDescription2line.setText('<b>' + totalHumanLabeledCount + '</b> human-tagged '+ ITEM_PLURAL + '. '+ statusMessage, false);
	        	        	}
	        	        	else{
	        				...
	        				AIDRFMFunctions.setAlert("No human tagged "+ ITEM_PLURAL + " present for this classifier.");
	        			}
	        		}
	        	});
	        ...
	        deleteTrainingExample: function(button){
	        	if (!button.exampleId){
	        		AIDRFMFunctions.setAlert("Error", "Error while delete human-tagged "+ ITEM_SINGULAR + ". Document Id not available.");
	        	}
	        	...
	        	Ext.Ajax.request({
	        		...
	        		success: function (response) {
	        			var resp = Ext.decode(response.responseText);
	        			if (resp.success) {
	        				AIDRFMFunctions.setAlert("Info", "Human-tagged "+ ITEM_SINGULAR + " is removed successfully. Note: this removal will be reflected on the automatic classifier the next time it is retrained.");
