...
Ext.define('TAGGUI.tagger-collection-details.view.TaggerCollectionDetailsPanel', {
           ...
           this.socialPublicLinkContainer = Ext.create('Ext.container.Container',{
                layout: 'hbox',
                margin: '10 0 0 0',
                hidden: true,
                items: [
           ...
           this.horizontalLineContainer = Ext.create('Ext.container.Container',{
                                                     //xtype: 'container',
                                                     margin: '10 0 0 0',
                                                     hidden: true,
           ...
           this.tabPanel = Ext.create('Ext.tab.Panel', {
                                      ...
                                      items: [
                                              ...
                                              {
                                              title: 'MicroMappers Volunteers',
                                              padding: '10 0 0 0',
                                              items: [
                                                      this.enableMicroMappersButton,
                                                      this.microMappersUI,
                                                      this.socialPublicLinkContainer,
                                                      this.pyBossaLink,
                                                      this.horizontalLineContainer,
                                                      this.UIBlock,
                                                      this.disableMicroMappersButton
                                                      ]
                                              }
                                              ]
                                      });
