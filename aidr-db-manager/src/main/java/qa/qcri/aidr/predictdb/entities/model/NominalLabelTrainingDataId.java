...
/**
 * NominalLabelTrainingDataId generated by hbm2java
 */
@Embeddable
public class NominalLabelTrainingDataId implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3215052855659829560L;
	...
	public NominalLabelTrainingDataId() {
	}

	public NominalLabelTrainingDataId(Long documentId, Long crisisId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NominalLabelTrainingDataId))
			return false;
		NominalLabelTrainingDataId castOther = (NominalLabelTrainingDataId) other;
