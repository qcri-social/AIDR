Welcome to the AIDR wiki! It contains information for AIDR developers and system administrators. If you want to use AIDR, see the Operator's Manual in FLOSS Manuals: http://en.flossmanuals.net/aidr
