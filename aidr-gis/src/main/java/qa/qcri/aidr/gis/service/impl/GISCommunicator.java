...
import qa.qcri.aidr.gis.service.AbstractCommunicator;
...
public class GISCommunicator extends AbstractCommunicator {
    // will be placed on config.
    protected static Logger logger = Logger.getLogger("GISCommunicator");

    public GISCommunicator(){
        super(GISCommunicator.class);
    }
