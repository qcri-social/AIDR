...
Half of the training tweets have the "WHITE" attribute value, and are made of random 10-word sequences of the words "light", "clear", "snow", and "clouds" followed by a random word (created by concatenating "w_" with a random 3-digit number).

Half of the training tweets have the "BLACK" attribute value, and are made of random 10-word sequences of the words "coal", "night", "coffee", and "ink" followed by a random word.

Example training tweets:

```
light clear light snow snow clouds clear light clear light w101 -> WHITE
clear clouds snow light clear snow clear clear light light w991-> WHITE
coal night coffee coffee night coal night ink ink night w720 -> BLACK
night coffee night coal coal ink night coffee coal night w899-> BLACK
```
