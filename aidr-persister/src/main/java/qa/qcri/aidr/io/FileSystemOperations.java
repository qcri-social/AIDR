...
public class FileSystemOperations {
    ...
    public static void deleteFilesOlderThanNMinutes(String folderLocation, String fileExtension, String skipPattern, Long timeInMinutes) {
    ...
    public static File getTheNewestFile(String filePath, String ext, String excludePattern) {
        File theNewestFile = null;
        File dir = new File(filePath);
        GenericExtFilter fileFilter = new GenericExtFilter(ext, excludePattern);
