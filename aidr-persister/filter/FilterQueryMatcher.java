	...
	public boolean isQueryMatch(QueryJsonObject q, ClassifiedTweet tweet) {
		if (q instanceof DateQueryJsonObject) {
			...
			if (q.getComparator().equals(ComparatorType.is_after)) {
				...
				System.out.println("For " + tweet.getTimestamp() + " comparing after date " + q.getTime() + " : " + matchResult);
				return matchResult;
			}
			if (q.getComparator().equals(ComparatorType.is_before)) {
				...
				System.out.println("For " + tweet.getTimestamp() + " comparing before date " + q.getTime() + " : " + matchResult);
				return matchResult;
			}	
		}
